...
exports.testTwoZonesFourCouples = testTwoZonesFourCouples;
exports.testThreeZonesFourCouples = testThreeZonesFourCouples;
exports.testMixedZoneSizes = testMixedZoneSizes;
exports.testLargeTournament = testLargeTournament;
exports.testSingleZone = testSingleZone;
const alternating_bracket_algorithm_1 = require("./alternating-bracket-algorithm");
...
function testTwoZonesFourCouples() {
    ...
    const result = (0, alternating_bracket_algorithm_1.generateAlternatingBracketSeeding)(couples);
    console.log(result.summary);
    // Verify zone separation
    const verification = (0, alternating_bracket_algorithm_1.verifyZoneSeparation)(result.seededCouples, result.bracketPairings);
    ...
    console.log(`\n🎯 Key Results:`);
    console.log(`  Zone A winner: Seed ${zoneAWinner === null || zoneAWinner === void 0 ? void 0 : zoneAWinner.seed} (${zoneAWinner === null || zoneAWinner === void 0 ? void 0 : zoneAWinner.bracketPosition})`);
    console.log(`  Zone B winner: Seed ${zoneBWinner === null || zoneBWinner === void 0 ? void 0 : zoneBWinner.seed} (${zoneBWinner === null || zoneBWinner === void 0 ? void 0 : zoneBWinner.bracketPosition})`);
    console.log(`  Can only meet in: ${(zoneAWinner === null || zoneAWinner === void 0 ? void 0 : zoneAWinner.bracketPosition) !== (zoneBWinner === null || zoneBWinner === void 0 ? void 0 : zoneBWinner.bracketPosition) ? 'FINAL' : 'EARLIER ROUND (BAD)'}`);
    return result;
}
/**
...
function testLargeTournament() {
    ...
    zones.forEach(zoneLetter => {
        for (let position = 1; position <= 4; position++) {
            couples.push(createTestCouple(`c${coupleId++}`, `z${zoneLetter.toLowerCase()}`, `Zone ${zoneLetter}`, position, 13 - position, // 12, 11, 10, 9 points respectively
            `Player ${zoneLetter}${position}A`, `Player ${zoneLetter}${position}B`));
        }
    });
    const result = (0, alternating_bracket_algorithm_1.generateAlternatingBracketSeeding)(couples);
    console.log(result.summary);
...
function testSingleZone() {
    ...
    console.log(`  Zone winner seed: ${(_a = result.seededCouples.find(c => c.zonePosition === 1)) === null || _a === void 0 ? void 0 : _a.seed}`);
    return result;
}
/**
 * Run all tests
