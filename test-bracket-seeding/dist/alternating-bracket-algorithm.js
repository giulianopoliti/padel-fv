...
exports.generateAlternatingBracketSeeding = generateAlternatingBracketSeeding;
exports.verifyZoneSeparation = verifyZoneSeparation;
/**
 ...
 */
function groupCouplesByPosition(couples) {
    const grouped = {};
 ...
 */
function applyAlternatingSeeding(couplesByPosition) {
    const seededCouples = [];
    let currentSeed = 1;
 ...
 */
function calculateBracketSize(totalCouples) {
...
function generateBracketPairings(seededCouples, bracketSize) {
    ...
    for (let i = 0; i < bracketSize; i += 2) {
        ...
        const couple1 = (posA !== null && posA !== void 0 ? posA : posB); // the non-null participant
 ...
 */
function generateBracketSummary(seededCouples, pairings, bracketSize) {
 ...
 */
function verifyZoneSeparation(seededCouples, pairings) {
    const issues = [];
