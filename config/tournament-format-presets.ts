...
export const TOURNAMENT_FORMAT_PRESETS: Record<TournamentFormatPresetId, TournamentFormatConfigV2> = {
  ...
  AMERICAN_MULTI_ZONE_GLOBAL_STANDINGS: {
    version: 2,
    presetId: 'AMERICAN_MULTI_ZONE_GLOBAL_STANDINGS',
    baseType: 'AMERICAN',
    zoneMode: 'MULTI_ZONE',
    zoneStage: 'FIXED_MATCH_COUNT',
    targetMatchesPerCouple: 3,
    ...
    display: {
      name: 'Americano por zonas (tabla general)',
      description: 'Zonas multiples con ranking general del torneo y llave por tabla global.',
    },
  },
